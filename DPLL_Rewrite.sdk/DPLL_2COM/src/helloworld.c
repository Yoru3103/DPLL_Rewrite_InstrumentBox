...
//	double Freq_meterB;
    ...
    Xil_Out32(PLL0_PID_GainP_Addr,10000000);
    Xil_Out32(PLL0_PID_GainI_Addr,4000000);
    Xil_Out32(PLL0_PID_GainI2_Addr,5000000);
    Xil_Out32(PLL0_PID_GainD_Addr,1000000);
