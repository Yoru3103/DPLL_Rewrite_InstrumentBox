...
### Ref 10MHz clockin -> exp_io_1
#set_property IOSTANDARD LVCMOS33 [get_ports ref_clk_in]
#set_property PACKAGE_PIN H16 [get_ports ref_clk_in]
#set_property PULLDOWN TRUE [get_ports ref_clk_in]
